	...
	<div class="culmn">
		...
		<div class="container">
			<div class="panel-body">
				<form name="frm_search" action="searchTeamList.sc" method="post"
					...
					<div class="col-xs-6 col-sm-1 text-right">
							<a href="searchTeam.sc" class="btn btn-lg"> <span
				...
				<tbody>
					<c:forEach items="${teamList}" var="team">
						<tr class="text-center">
							<td>${team.schtNo}</td>
							<td>${team.schtName}</td>
							<td><a href="searchTeamView.sc?schtNo=${team.schtNo}">${team.schtTitle}</a>
							</td>
