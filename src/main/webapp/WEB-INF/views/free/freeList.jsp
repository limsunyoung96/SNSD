	...
	<div class="container">
		...
		<div class="collapse in panel panel-default" id="id_search_area">
			<div class="panel-body">
				<form name="frm_search" action="freeList.sc" method="post"
		...
		<div class="row" style="margin-bottom: 10px;">
            ...
            &nbsp;새글쓰기
				...
				%>
			<div class="col-sm-1 text-right">
				<a href="freeForm.sc" class="btn btn-primary btn-sm"> <span
			...
			<tbody>
				...
				<c:forEach var="bo" items="${boards}">
					<tr class="text-center">
						<td>${bo.boNo}</td>
						<td class="text-left"><a href="freeView.sc?boNo=${bo.boNo}">
								${bo.boTitle} </a></td>
						<td>
							<%
								user.getUserName();
		...
		<nav class="text-center">
			<mytag:paging pagingVO="${searchVO}" linkPage="freeList.sc" />
		</nav>
		<!-- END : 페이지네이션  -->
