...
<div class="container">
  <div class="page-header">
    <h3> 팀홍보게시판 - <small>글 수정</small></h3>
  </div>	
	<form:form action="freeModify.sc" modelAttribute="free" >
		...
		<tr>
          ...
          <div class="pull-left">
            ...
            <div class="pull-right">
              ...
              <button type="submit"  formaction="freeDelete.sc" class="btn btn-sm btn-danger"> 
