...
<div class="container">
  <div class="page-header">
	...
	<%-- <form action="applyModify.sc" method="post"> --%>
	<form:form action="applyModify.sc" modelAttribute="applyVO">
	<%-- <input type="hidden" name="boNo" value="${applyVO.boNo}"> --%>	
	...
	<table class="table table-striped table-bordered">
      ...
      <td>${applyVO.boNo}</td>
		...
		<tr>
			<th>제목</th>
			<td><%-- <input type="text" name="boTitle" value="${applyVO.boTitle}" class="form-control input-sm"> --%>
		...
		<tr>
			<th>작성자</th>
			<td><%-- <input type="text" name="boWriter" value="${applyVO.boWriter}"  class="form-control input-sm"> --%>
				...
				<%-- <select name="boCategory" class="form-control input-sm" >
					<option value="">-- 선택하세요--</option>		
						<c:forEach items="${categorylist}" var="code">
							<option value="${code.commCd}" ${code.commCd eq applyVO.boCategory ? "selected='selected'": "" }>${code.commNm}</option>
						</c:forEach>			
				</select> --%>
				<td>
		...
		<tr>
			<th>내용</th>
			<td><textarea rows="10" name="boContent" class="form-control input-sm">${applyVO.boContent}</textarea>
			</td>
		</tr>
    <tr>
      <th>IP</th>
    ...
    <tr>
      ...
      <td>${applyVO.boRegDate}</td>
		...
		<tr>
			<td colspan="2">
          <div class="pull-left">
              <a href="applyList.sc" class="btn btn-default btn-sm"> 
            ...
            <div class="pull-right">
              ...
              <button type="submit"  formaction="applyDelete.sc" class="btn btn-sm btn-danger"> 
