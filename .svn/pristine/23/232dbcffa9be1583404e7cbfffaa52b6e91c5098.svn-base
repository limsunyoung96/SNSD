		...
		<section id="history" class="history sections">
			<div class="container">
				<div class="row">
					<div class="container">
						...
						<table class="table table-hover">
							<tbody>
								...
								<tr>
									<th>시간대</th>
									<td>${mem.schmTimeNm}</td>
								</tr>
								<!-- 비밀번호는 보여주지 않음  -->
								<tr>
									<th>내용</th>
									<td><pre>${mem.schmContent}</pre></td>
								</tr>
					...
					<a href="searchMemEdit.sc?schmNo=${mem.schmNo}" class="btn btn-lg"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>&nbsp;&nbsp;수정</a>
					</div>
				</div>
			</div>
	</div>
