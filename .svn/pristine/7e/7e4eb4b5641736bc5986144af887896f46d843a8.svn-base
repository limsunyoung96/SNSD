			...
			<div class="row">
				<div class="main_pricing_area sections">
					<div class="head_title text-center">
						<h2>Find our Member</h2>
						<div class="subtitle">우리와 맞는 맞는 선수를 찾아보세요!</div>
						<div class="separator"></div>
					</div>
					<!-- End off Head_title -->
					<div class="col-sm-12">
						<div class="single_contant_left padding-bottom-90">
							<form action="searchMem.sc" id="formid" method="post">
								<div
									...
									<div class="row">
										<div class="col-sm-12">
											<div style="vertical-align: middle; text-align-last: center;"
												class="form-group">
												<input type="text" class="form-control" name="schmTitle"
									...
									<div class="form-group">
										<textarea
											style="vertical-align: middle; text-align-last: center;"
											class="form-control" name="schmContent" rows="3"
											placeholder="Message"></textarea>
									</div>
									<div class="">
										<input type="submit" value="구인하기" class="btn btn-lg">
									</div>
								</div>
							</form>
						</div>
