			...
			<div class="container">
				<div class="row">
					<div class="container">
						...
						<form:form action="searchTeamModify.sc" modelAttribute="team">
							<form:hidden path="schtNo" />
							<table class="table table-hover">
								<tbody>
									...
									<tr>
										<th>포지션</th>
										<td><form:select path="schtPositionNm"
									...
									<tr>
										<th>지역</th>
										<td><form:select path="schtRegionNm"
												cssClass="form-control input-sm">
												<option value="">--선택하세요--</option>
									...
									<tr>
										<th>시간대</th>
										<td><form:select path="schtTimeNm"
												cssClass="form-control input-sm">
												<option value="">--선택하세요--</option>
									...
									<tr>
										<th>내용</th>
										<td><form:input path="schtContent"
												cssClass="form-control input-sm" /></td>
									</tr>
									...
									<tr>
										<td colspan="2">
											<div class="pull-left">
												<a href="searchTeamList.sc" class="btn btn-danger btn-sm"> <span
											...
											<div class="pull-right">
												...
												<button type="submit" formaction="searchTeamDelete.sc"
